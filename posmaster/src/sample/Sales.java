...
public class Sales implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        p1.setCellValueFactory(new PropertyValueFactory<>("purchase"));
...
editableCol();
        ...
        table1.setRowFactory( tv -> {
            ...
            row.setOnMouseClicked(event -> {
                ...
                }else if (event.getClickCount() <= 1) {Q1.setCellValueFactory(new PropertyValueFactory<>("1"));}
            });
            return row ;
        });
       ...
       // newsale.setOnAction(controlEvent);
        //btnRefresh.setOnAction(controlEvent);
